...
@section('main')
    <div class="main-content">
        <section class="section">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-5 col-5 col-sm-2">
                    <div class="card">
                        <div class="card-header">
                            <h4>Statistics</h4>
                ...
                <div class="col-lg-6 col-md-15 col-15 col-sm-15">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <ul class="list-unstyled list-unstyled-border">
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="media-title">juju</div>
                                        <span class="text-small text-muted">sumenep</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
